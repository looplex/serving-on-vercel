...
function IsgPage (props) {
  ...
  return (
    <main>
      ...
      <h1>Isg Page</h1>
      Hi! I am a <code>Incrementally Static Generated</code> Page born in <mark><time dateTime={dttm.toISOString()}>{dttm.toLocaleString()}</time></mark>, but it&apos;s <mark><Clock /></mark> now.<br />
      and my slug is: <code>{props.slug}</code>. Feel free to visit my siblings <Link href='/isg/foobar'><a>foobar</a></Link> and <Link href='/isg/undefined'><a>undefined</a></Link> to understand more about <code>ISG</code> pages.
    </main>
  )
}
