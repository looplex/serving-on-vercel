...
function IsrPage (props) {
  ...
  return (
    <main>
      ...
      <h1>Isr Page</h1>
      Hi! I am a <code>Incrementally Static Regenerated</code> Page born in{' '}
      <mark>
      ...
      <Link href='/isr/foobar'>
        <a>foobar</a>
      </Link>{' '}
      and{' '}
      <Link href='/isr/undefined'>
        <a>undefined</a>
      </Link>{' '}
      to understand more about <code>ISR</code> pages.
    </main>
  )
}
